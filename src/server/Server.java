...
public abstract class Server{
  ...
  /**
   * Konstruktor. Initialisiert das neue Server-Objekt mit der Referenz auf das Empf?申ngerobjekt.
   * @param serverApplication Das Empf?申ngerobjekt des Bomberman-Servers f?申r Nachrichten.
   */
